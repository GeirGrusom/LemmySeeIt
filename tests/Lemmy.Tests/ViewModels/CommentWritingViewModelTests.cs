...
internal sealed class CommentWritingViewModelTests
{
    ...
    {
        var comment = new CommentViewModel(Sample.CommentNode(), Now, SignedInApi(), TheAuthor(), Media(), Copier(), new RecordingNavigator());
    ...
    {
        var comment = new CommentViewModel(Sample.CommentNode(), Now, SignedInApi(), SomebodyElse(), Media(), Copier(), new RecordingNavigator());
    ...
    public void SignedOutThereIsNothingToDoWithAComment()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(), Now, api, new CurrentAccount(), Media(), Copier(), new RecordingNavigator());
    ...
    public async Task AReplyAppearsUnderTheCommentItAnswers()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(), Now, api, TheAuthor(), Media(), Copier(), new RecordingNavigator());
    ...
    public async Task AReplyIsSentAgainstTheCommentBeingAnswered()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(id: 100), Now, api, TheAuthor(), Media(), Copier(), new RecordingNavigator());
        comment.ReplyCommand.Execute(null);
        comment.Composer!.Text = "Quite so.";
        await comment.Composer.SubmitCommand.ExecuteAsync(null);
    ...
    public async Task EditingRewritesTheTextAndKeepsTheRepliesBelowIt()
    {
        ...
        var comment = new CommentViewModel(node, Now, api, TheAuthor(), Media(), Copier(), new RecordingNavigator());
    ...
    public async Task RestoringPutsTheTextBack()
    {
        ...
        var comment = new CommentViewModel(deleted, Now, api, TheAuthor(), Media(), Copier(), new RecordingNavigator());
