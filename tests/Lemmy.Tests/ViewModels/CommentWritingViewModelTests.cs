...
internal sealed class CommentWritingViewModelTests
{
    ...
    {
        var comment = new CommentViewModel(Sample.CommentNode(), Threads.Context(SignedInApi(), TheAuthor()));
    ...
    {
        var comment = new CommentViewModel(Sample.CommentNode(), Threads.Context(SignedInApi(), SomebodyElse()));
    ...
    public void SignedOutThereIsNothingToDoWithAComment()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(), Threads.Context(api, new CurrentAccount()));
    ...
    public async Task AReplyAppearsUnderTheCommentItAnswers()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(), Threads.Context(api, TheAuthor()));
    ...
    public async Task AReplyIsSentAgainstTheCommentBeingAnswered()
    {
        ...
        var comment = new CommentViewModel(Sample.CommentNode(id: 100), Threads.Context(api, TheAuthor()));
        comment.ReplyCommand.Execute(null);
        comment.Composer!.Text = "Quite so.";
        await comment.Composer.SubmitCommand.ExecuteAsync(null);
    ...
    public async Task EditingRewritesTheTextAndKeepsTheRepliesBelowIt()
    {
        ...
        var comment = new CommentViewModel(node, Threads.Context(api, TheAuthor()));
    ...
    public async Task RestoringPutsTheTextBack()
    {
        ...
        var comment = new CommentViewModel(deleted, Threads.Context(api, TheAuthor()));
